method RXTSET_DELETE_ENTITY.

    DATA:   lv_id_tech  TYPE ztca_eltecnicos-idtech,
            lv_id_complaint TYPE ztca_elreclamo-idcomplaint.
    ...
    IF sy-subrc EQ 0.
        lv_id_complaint = <fs_key_tab>-value.
    ENDIF.

    DELETE FROM ztca_elrecxtech 
    WHERE idtech        EQ lv_id_tech
    AND idcomplaint     EQ lv_id_complaint.
